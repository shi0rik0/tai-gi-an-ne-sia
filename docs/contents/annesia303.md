...
「小可」一詞是古漢語的遺留。現代中文有一個成語叫「非同小可」，意即「不是小事兒」，但「非同小可」是文言詞，要唸成hui-tông-siáu-khó，用的是文讀音；「小可仔」唸成sió-khuá-á，用的是白話音。白話音比文讀音古，「小可仔」一詞大概來源也很古。

閩南語「可」的音讀除了在「小可仔」一詞唸khuá以外，大部分唸成文讀音khó，例如：可愛、可惜、許可（hí-khó）。泉州音也唸khónn，用於「可惡」（khónn-ònn）一詞。
